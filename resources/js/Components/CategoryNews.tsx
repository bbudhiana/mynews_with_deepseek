    ...
    return (
        <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
                ...
                <Link href={`/category/${data?.slug || 'nasional'}`} className="text-accent text-sm font-medium hover:underline">
                    Lihat Semua →
                </Link>
            </div>
                    ...
                    <article key={article.id} className="group">
                        <div className="relative overflow-hidden mb-4">
                            <img
                                ...
                                loading="lazy"
                                decoding="async"
                                className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300 bg-card"
